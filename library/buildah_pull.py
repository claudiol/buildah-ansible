...
'''
def buildah_pull ( module, name, authfile, cert-dir, quiet, signature-policy, tls-verify ): 
...
def main():
    ...
    rc, out, err =  buildah_pull ( module, name, authfile, cert-dir, quiet, signature-policy, tls-verify )
